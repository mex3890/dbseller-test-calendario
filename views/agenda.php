...
<div class="container-fluid">
    <table class="table table-striped">
        ...
        <tr>
            <th style="font-size: 0.8rem;border: none" scope="col"><a href="?path=agenda">#Áreas</a></th>
            <?php for ($m = $mInicial; $m <= $mFinal; $m++) : ?>
                <th scope="col" style="font-size: 0.8rem;border: none"><a
                            href="?path=agenda&meses=<?php echo $m; ?>"><?php echo date("F", mktime(0, 0, 0, $m)); ?></a>
                </th>
            <?php endfor; ?>
            <th scope="col" style="font-size: 0.8rem;border: none">
                Ações<a class="action-button create" href="?path=areas/criar">Criar Novo</a>
            </th>
        </tr>
        </thead>
        <tbody>
        <?php foreach ($areas as $area) : ?>
            <tr>
                <th scope="row"><a href="?path=agenda&area=<?php echo $area->id; ?>"><?php echo $area->descricao; ?></a>
                </th>
                <?php for ($m = $mInicial; $m <= $mFinal; $m++) : ?>
                    <td>
                                        ...
                                        <?php foreach ($melhoriasEncontradas as $melhoria) : ?>
                                            <td class="table-<?php echo $urgencia->id == 5 ? 'primary' : ($urgencia->id == 4 ? 'danger' : 'warning'); ?>">
                                                ...
                                                <div class="wrapper-melhoria"
                                                    ...
                                                    <!-- Modal -->
                                                    <div class="modal fade" id="melhoria_<?php echo $melhoria->id ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title"
                                                                        id="melhoria_<?php echo $melhoria->tarefa ?>"><?php echo $melhoria->title ?></h5>
                                                                    ...
                                                                    <form>
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control mb-2"
                                                                                      id="descricao" rows="8"
                                                                                      readonly><?php echo $melhoria->descricao ?></textarea>
                                                                        </div>
                                                                        <div class="form-group form-row">
                                                                            <div class="col">
                                                                                <label for="prazo_legal">Prazo
                                                                                    legal</label>
                                                                                <input type="text"
                                                                                       ...
                                                                                       readonly
                                                                                       value="<?php echo $prazoLegal ?>">
                                                                            </div>
                                                                            <div class="col">
                                                                                <label for="prazo_acordado">Prazo
                                                                                    acordado</label>
                                                                                <input type="text" class="form-control"
                                                                                       id="prazo_acordado"
                                                                                       placeholder="Prazo acordado"
                                                                                       readonly
                                                                                       value="<?php echo $prazoAcordado ?>">
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group form-row">
                                                                            <div class="col">
                ...
                <td>
                    <?php if ($area->melhorias === 0) { ?>
                        <a class="action-button update" href="?path=areas/editar&area=<?= $area->id; ?>">Atualizar</a>
                        <a class="action-button delete" href="?path=areas/deletar&area=<?= $area->id; ?>">Deletar</a>
                    <?php } ?>
                </td>
            </tr>
        <?php endforeach; ?>
